...
import { FaUser, FaList, FaIdBadge } from 'react-icons/fa';
import { Link } from 'react-router-dom';

const navbarMenu = [
  { id: 1, name: "User Details", link: '/user', icon: <FaUser /> },
  { id: 2, name: "Your Order", link: '/user/your-order', icon: <FaList /> },
  { id: 3, name: "Your Profile", link: '/profile', icon: <FaIdBadge /> }, // ✅ Added Profile
];
